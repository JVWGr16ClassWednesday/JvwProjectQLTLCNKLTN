        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-body">
                    <a href="DangNhap.jsp" target="" class="button2 hvr-shutter-in-vertical">Admin</a>
                    <a href="DangNhapGV.jsp" target="" class="button2 hvr-shutter-in-vertical">Giảng Viên</a>
                    <a href="DangNhapSV.jsp" target="" class="button2 hvr-shutter-in-vertical">Sinh Viên</a>
                </div>
            </div>
        </div>
    </div>
