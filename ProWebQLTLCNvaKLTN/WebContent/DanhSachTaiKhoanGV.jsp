...
<sql:query var="items"
	sql="SELECT id, username FROM users WHERE accessright='1'" />
	...
	<div class="container">
		<form action="QuanLyTaiKhoanServlet" method="post">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn btn-danger btn-xs"
													...
													onclick="XoaTaiKhoan('${row[0]}')" name="btnXoa">
			...
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-body">
						<a href="TimDanhSachTaiKhoan.jsp" class="btn btn-primary">Trở
							về</a>
					</div>
				</div>
			</div>
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="id">Mã GV/ Mã SV :</label> <input type="text"
							class="form-control" id="id" required value="GV10122">
					</div>
					<div class="form-group">
						<label for="name">Họ tên :</label> <input type="text"
							class="form-control" id="name" required
							value="Trương Thị Ngọc Phượng">
					</div>
					<div class="form-group">
						<label for="email">Email :</label> <input type="email"
							class="form-control" id="email" required value="abs@gmail.com">
					</div>
					<label>Quyền hệ thống</label> <br /> <br /> <label><input
						type="radio" value="1">&nbsp;Quyền Giảng Viên</label> <br /> <br />
					<label><input type="radio" value="2">&nbsp;Quyền
						Sinh Viên</label>
				</div>
	...
	<div class="modal fade" id="modalXoa" role="dialog">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="hidden" id="row_id" name="row_id" /> <label>Bạn
							có muốn xóa tài khoản này</label>
					</div>
				</div>
				<div class="modal-footer">
